...
<head>
    ...
    fbq('init', '893711902307423');
    fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
    src="https://www.facebook.com/tr?id=893711902307423&ev=PageView&noscript=1"
    /></noscript>
    <!-- End Meta Pixel Code -->
...
s.parentNode.insertBefore(t,s)}(window, document,'script',
'https://connect.facebook.net/en_US/fbevents.js');
fbq('init', '382194897631490');
fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=382194897631490&ev=PageView&noscript=1"
/></noscript>
<!-- End Meta Pixel Code -->
</head>
<style>
    ...
    <div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-200">
        ...
        <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" class="fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-300 transform bg-gray-900 lg:translate-x-0 lg:static lg:inset-0">
            <div class="flex items-center justify-center mt-8">
                <div class="flex items-center">
                    <span class="mx-2 text-2xl font-semibold text-white">Najiat Admin</span>
                </div>
            </div>
        ...
        <div class="flex flex-col flex-1 overflow-hidden">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                <div class="container px-0 md:px-6 py-8 mx-auto">
                    @yield('content')
                </div>
            </main>
        </div>
