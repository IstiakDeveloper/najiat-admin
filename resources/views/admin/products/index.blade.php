            ...
            <tbody class="divide-y divide-gray-200 bg-white ">
                @foreach ($products as $product)
                    <tr>
                        ...
                        <td class="py-2 px-4 text-center">{{ $product->author }}</td>
                        <td class="py-2 px-4 text-center">{{ $product->category->name }}</td>
                        <td class="py-2 px-4 text-center">{{ $product->purchase_price  }}</td>
                        <td class="py-2 px-4 text-center">{{ $product->regular_price }}</td>
                        <td class="py-2 px-4 text-center">{{ $product->sale_price }}</td>
                        <td class="py-2 px-4 text-center">{{ $product->stock_quantity }}</td>
