<div>
    <div>
        <section class="mb-8">
            <livewire:product-slider :products="$products" />
        </section>
        <!-- Product Section -->
        <section class="mb-8">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-8">
                ...
                <div class="group relative">
                        ...
                        <div class="bg-white p-4 rounded-lg text-center group-hover:shadow-lg transition duration-300 ease-in-out">
                            ...
                            <div class="flex items-center justify-center relative mb-4">
                                ...
                                @if ($product->sale_price < $product->regular_price)
                                    <div class="absolute top-0 right-0 bg-purple-500 text-white p-2 rounded-full">
                            ...
                            <!-- Product Details -->
                                ...
                                <p class="text-purple-500 font-semibold">{{ $product->author }}</p>
                    ...
                    <div class="absolute inset-0 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 bg-purple-200 transition-opacity duration-300">
                        <button class="bg-purple-500 text-white px-4 py-2 rounded-md mr-4 transition duration-300 ease-in-out transform hover:scale-105" wire:click="addToCart({{ $product->id }})">
        ...
        <section class="mb-8">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-8">
                @foreach ($categories as $category)
                    <div class="group hover:opacity-80 transition-all ease-in-out">
